...
let time = +prompt('Введите число от 1 до 60');
if (time <= 15) {
...
let dayDate = +prompt('Введите число от 1 до 31');
if (dayDate <= 10) {
...
let plan = prompt('Введите день недели на англ.')
...
let a = prompt('Введите значение пременой a');
let b = prompt('Введите значение пременой b')
...
if (coursesAndDurationArray[0].monthDuration > 5) {
    console.log(coursesAndDurationArray[0].title + ' Супер ' + coursesAndDurationArray[0].monthDuration + ' мес.');
}

if (coursesAndDurationArray[1].monthDuration > 5) {
    console.log(coursesAndDurationArray[1].title + ' Супер ' + coursesAndDurationArray[1].monthDuration + ' мес.');
}

if (coursesAndDurationArray[2].monthDuration > 5) {
    console.log(coursesAndDurationArray[2].title + ' Супер ' + coursesAndDurationArray[2].monthDuration + ' мес.');
}

if (coursesAndDurationArray[3].monthDuration > 5) {
    console.log(coursesAndDurationArray[3].title + ' Супер ' + coursesAndDurationArray[3].monthDuration + ' мес.');
}

if (coursesAndDurationArray[4].monthDuration > 5) {
    console.log(coursesAndDurationArray[4].title + ' Супер ' + coursesAndDurationArray[4].monthDuration + ' мес.');
}

if (coursesAndDurationArray[5].monthDuration > 5) {
    console.log(coursesAndDurationArray[5].title + ' Супер ' + coursesAndDurationArray[5].monthDuration + ' мес.');
}
...
//
// } else {
//     console.log('Таких значений в этом массиве НЕТ!');
// }
